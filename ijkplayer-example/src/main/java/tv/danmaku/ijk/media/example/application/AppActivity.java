...
public class AppActivity extends AppCompatActivity {
    ...
    public Button btnLocal,btnOnline;
    public EditText etOnlineUrl;
    ...
    private void initView(){
        btnLocal=findViewById(R.id.btn_local_video);
        btnOnline=findViewById(R.id.btn_online_video);
        etOnlineUrl=findViewById(R.id.et_online_url);
    }
